        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          <AosBox animation="slide-right" delay={100}>
            <SectionHeading
              ...
              title={['Wir freuen uns', <span key="accent" className="text-yellow-600">auf Sie</span>]}
              ...
              {contactRows.map((row) => (
                <div key={row.label} className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-olive-100 border border-olive-300/70 flex items-center justify-center shrink-0">
                    <svg aria-hidden="true" focusable="false" width="18" height="18" viewBox="0 0 18 18" fill="none" className="text-olive-600">
                      {row.icon}
                    </svg>
                  </div>
                  <div>
              ...
              {submitted ? (
                <div className="py-10 text-center">
                  <div className="w-14 h-14 rounded-full bg-olive-100 border border-olive-300/70 flex items-center justify-center mx-auto mb-4">
                    <svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-olive-600">
