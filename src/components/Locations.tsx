...
export default function Locations() {
  return (
    <section id="standorte" className="py-32 md:py-44 my-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {locations.map((loc, i) => (
            <AosBox
              ...
              className="h-full"
            >
              <div className="rounded-3xl bg-stone-950/80 backdrop-blur-md border border-white/10 p-8 md:p-10 hover:border-cloud-400/50 transition-all duration-300 shadow-2xl hover:-translate-y-2 flex flex-col justify-between h-full">
                <div>
